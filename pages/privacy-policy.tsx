  ...
  return (
    <Section flexGrow={1}>
      <Box maxWidth={880} p={gridP}>
        ...
        <Typography variant="h3" paragraph mt={6}>
        ...
        <Typography fontWeight={800}>How do we record your data?</Typography>
        <Typography paragraph>
        ...
        <Typography paragraph>
          ...
          contact us at any time. The right to demand a restriction of
        ...
        <ul>
          ...
          <li>
            <Typography paragraph>The used operating system</Typography>
          </li>
          <li>
            <Typography paragraph>Referrer URL</Typography>
          </li>
          <li>
            <Typography paragraph>
          ...
          <li>
            <Typography paragraph>he time of the server inquiry</Typography>
          </li>
          <li>
            <Typography paragraph>The IP address</Typography>
          </li>
        </ul>
        ...
        <Typography paragraph>
          ...
          the page, the utilized operating system and the user’s origin. Google
          may consolidate these data in a profile that is allocated to the
        ...
        <Typography fontWeight={800}>IP anonymization</Typography>
        <Typography paragraph>
        ...
        <Typography fontWeight={800}>Browser plug-in</Typography>
        <Typography paragraph>
        ...
        <Typography fontWeight={800}>Contract data processing</Typography>
        <Typography paragraph>
        ...
        <Typography paragraph>
          ...
          within the Google advertising network. This allows reports to be
          created that contain information about the age, gender, and interests
          of the website visitors. The sources of this information are
          interest-related advertising by Google as well as visitor data
          obtained from third-party providers. This data cannot be allocated to
          a specific individual. You have the option to deactivate this function
          at any time by making pertinent settings changes for advertising in
          your Google account or you can generally prohibit the recording of
          your data by Google Analytics as explained in section “Objection to
          the recording of data”.
        </Typography>
        <Typography fontWeight={800}>Archiving period</Typography>
        <Typography paragraph>
          ...
          advertising ID) will be anonymized or deleted after 14 months. For
